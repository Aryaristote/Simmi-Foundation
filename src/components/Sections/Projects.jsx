    ...
    <Wrapper id="projects">
      <div className="whiteBg">
        <div className="container">
          <HeaderInfo>
            <h1 className="font40 extraBold">Current and Upcoming events</h1>
            <p className="font13">
          ...
          <div className="row textCenter">
            <div className="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <ProjectBox
                img={ProjectImg1}
                title="Wellness and health, a vital concept.Google Meet"
      ...
      <div className="lightBg">
        <div className="container">
          <Advertising className="flexSpaceCenter">
            ...
            <AddRight>
              <h4>"--- Did not finish the implimentation ---"</h4>
              <h2 className="font40 extraBold">News from Tweeter</h2>
              <p className="font12">
              ...
              <ButtonsRow className="flexNullCenter" style={{ margin: "30px 0" }}>
                <div style={{ width: "190px", marginLeft: "15px" }}>
                  <FullButton title="View the whole Feed" action={() => alert("clicked")} border />
                </div>
              </ButtonsRow>
            </AddRight>
          </Advertising>
